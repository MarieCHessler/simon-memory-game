...
describe("game object contains correct keys", () => {
    ...
    test("lastButton key exists", () => {
        expect("lastButton" in game).toBe(true); // Check that lastButton key exists
    });
    test("turnInProgress key exists", () => {
        expect("turnInProgress" in game).toBe(true); // Check that turnInProgress key exists
    });
    test("turnInProgress key value is false", () => {
        expect("turnInProgress" in game).toBe(true); // Check for a default value for turnInProgress
    });
